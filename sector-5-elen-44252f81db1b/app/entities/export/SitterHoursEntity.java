...
public class SitterHoursEntity implements Serializable {
    ...
    /**
     * Instantiates a new Sitter hours entity.
     *
     * @param sitter the sitter
     * @param start  the start
     * @param end    the end
     */
    public SitterHoursEntity(final SitterModel sitter, final DateTime start, final DateTime end) {
        ...
        ExpressionList<EffectiveCareModel> query = EffectiveCareModel.find.query().where()
            .eq("effectiveUnavailability.plannedUnavailability.sitter", sitter)
