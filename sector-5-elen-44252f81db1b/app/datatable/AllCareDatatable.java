...
import views.html.back.admin.cares.all.ActionsDisplay;
 ...
 * @since 20.08.17
 */
public class AllCareDatatable extends ADatatable<EffectiveCareModel> implements RequestBehavior {
    ...
    public AllCareDatatable(final MessagesApi messagesApi, final FormFactory formFactory) {
